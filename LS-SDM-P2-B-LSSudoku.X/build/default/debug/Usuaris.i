...
signed char UcheckExistsGetError(){
...
void Uinit(){
    ...
    numUsuaris = 7;
     ...
     escriureCharEEPROM('a',2);
     escriureCharEEPROM('b',20);
     escriureCharEEPROM('c',38);
     escriureCharEEPROM('d',56);
     escriureCharEEPROM('e',74);
     escriureCharEEPROM('f',92);
     escriureCharEEPROM('g',110);
