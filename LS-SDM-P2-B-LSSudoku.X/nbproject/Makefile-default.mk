...
SOURCEFILES_QUOTED_IF_SPACED=LcTLCD.c main.c Ssms.c TeTeclat.c TiTTimer.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/LcTLCD.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/Ssms.p1 ${OBJECTDIR}/TeTeclat.p1 ${OBJECTDIR}/TiTTimer.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/LcTLCD.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/Ssms.p1.d ${OBJECTDIR}/TeTeclat.p1.d ${OBJECTDIR}/TiTTimer.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/LcTLCD.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/Ssms.p1 ${OBJECTDIR}/TeTeclat.p1 ${OBJECTDIR}/TiTTimer.p1

# Source Files
SOURCEFILES=LcTLCD.c main.c Ssms.c TeTeclat.c TiTTimer.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/LS-SDM-P2-B-LSSudoku.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/LS-SDM-P2-B-LSSudoku.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1    -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/LS-SDM-P2-B-LSSudoku.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
